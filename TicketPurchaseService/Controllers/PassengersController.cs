...
namespace TicketPurchaseService.Controllers
{
    public class PassengersController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Passenger.Include(p => p.Citizenship).Include(p => p.Person);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["PersonId"] = new SelectList(_context.Set<Person>(), "Id", "FirstName");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,PassportNumber,PersonId,CountryId")] Passenger passenger)
        {
            ...
            ViewData["CountryId"] = new SelectList(_context.Set<Country>(), "Id", "Id", passenger.CountryId);
            ViewData["PersonId"] = new SelectList(_context.Set<Person>(), "Id", "FirstName", passenger.PersonId);
            return View(passenger);
        }
