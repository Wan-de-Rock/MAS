...
namespace TicketPurchaseService.Controllers
{
    public class CountriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,TwoLetterISOCountryCode,ThreeLetterISOCountryCode")] Country country)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,TwoLetterISOCountryCode,ThreeLetterISOCountryCode")] Country country)
        {
            if (id != country.Id)
            {
                return NotFound();
