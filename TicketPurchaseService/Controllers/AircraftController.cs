...
namespace TicketPurchaseService.Controllers
{
    public class AircraftController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Aircraft.Include(a => a.Airline);
        ...
        public async Task<IActionResult> Create([Bind("Number,SeatsNumber,AirlineId")] Aircraft aircraft)
        {
            ...
            ViewData["AirlineId"] = new SelectList(_context.Airline, "Id", "Id", aircraft.AirlineId);
            return View(aircraft);
        }
        ...
        {
          return (_context.Aircraft?.Any(e => e.Number == id)).GetValueOrDefault();
        }
    }
}
